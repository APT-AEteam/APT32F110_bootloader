...
#define PIN_CHECK_VALUE        0x40 

#define UART_PRINT_DIV  (48000000/BOOTLOADER_PRINT_BORD)  //串口波特率分频数 = pclk/baudrate
#define UART_PROG_DIV   (48000000/BOOTLOADER_PROG_BORD)   //串口波特率分频数 = pclk/baudrate
